...
public class MealDebitCreditAdapter extends ArrayAdapter<DebitInfo> {


    public MealDebitCreditAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull List<DebitInfo> debitInfos) {
